...
const Cognitive:NextPage = () => {
    ...
    <b className={styles.cognitive}>{`Cognitive `}</b>
    <div className={styles.navigatingAWebsite}>Navigating a website can present significant challenges for individuals with cognitive disabilities, impacting their ability to process information, make decisions, and complete tasks efficiently. This page aims to explore the effects of these challenges and provide insights into creating more inclusive and accessible web experiences for all users.</div>
    </div>
    <div className={styles.navigation}>
    <div className={styles.items}>
    <div className={styles.speech}>Physical</div>
    <div className={styles.speech}>Auditory</div>
    ...
    <div className={styles.physical}>About</div>
    <div className={styles.physical}>Contact</div>
    <div className={styles.physical}>Polices</div>
    </div>
    <div className={styles.items2}>
    <div className={styles.company}>More</div>
    <div className={styles.physical}>Physical</div>
    <div className={styles.physical}>Auditory</div>
    <div className={styles.physical}>Speech</div>
    </div>
    <div className={styles.items3}>
    <div className={styles.company}>Help</div>
    <div className={styles.physical}>Polices</div>
    <div className={styles.physical}>About</div>
    <div className={styles.physical}>Contact</div>
    </div>
